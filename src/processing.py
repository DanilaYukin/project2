...
def sort_by_date(original_list: list[dict: str | int], reverse_list: bool = True) -> list[dict: str | int]:
    ...
    отсортированный по убыванию data даты"""
    new_dict_list = sorted(original_list, key=lambda original_list: original_list["data"], reverse=reverse_list)
    return new_dict_list


if __name__ == "__main__":
    print(filter_by_state([{"id": 41428829, "state": "EXECUTED", "data": "2019-07-03T18:35:29.512364"},
    ...
    print(sort_by_date([{"id": 41428829, "state": "EXECUTED", "data": "2019-07-03T18:35:29.512364"},
                        {"id": 939719570, "state": "EXECUTED", "data": "2018-06-30T02:08:58.425572"},
                        {"id": 594226727, "state": "CANCELED", "data": "2018-09-12T21:27:25.241689"},
                        {"id": 615064591, "state": "CANCELED", "data": "2018-10-14T08:21:33.419441"}]))
