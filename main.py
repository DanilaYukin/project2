...
"""
    ...
    if menu_item == "1":
        ...
        transactions = json_open(os.path.join("./data\\operations.json"))
        break
    elif menu_item == "2":
        print("Для обработки выбран CSV-файл.")
        transactions = csv_open(os.path.join("./data/transactions.csv"))
        break
    elif menu_item == "3":
        print("Для обработки выбран XLSX-файл.")
        transactions = xls_open(os.path.join("./data/transactions_excel.xlsx"))
        break
    else:
...
if filter_by_word.lower() == "да":
    ...
    filtered_transactions = sort_str(filtered_transactions, word)
